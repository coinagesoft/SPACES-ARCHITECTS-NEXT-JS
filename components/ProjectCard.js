...
export default function ProjectCard({ id, image, name, excerpt }) {
  const content = (
    <article>
      ...
      {excerpt && (
        <>
          ...
          <span className="inline-block mt-2 text-xs uppercase tracking-widest2 text-accent">Read more</span>
        </>
      )}
    </article>
  );
